...
####### ML Tab ###########
    ...
    def MLPlotButtonClicked(self):
        ...
        if self.MLModel != []:
            ...
            XX, YY, Z0, novelX, prob  = MLFunctionsForUI.create_uncertainity_plot_values(self.ML_model_name, self.MLModel, self.latent_model, self.proj_data, self.latent_scaler, self.MLscaler)
            self.prob = prob
