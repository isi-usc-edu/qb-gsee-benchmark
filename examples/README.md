...
2. The [`fetch_file_from_sftp_server.py`](fetch_file_from_sftp_server.py) script is a very brief example of downloading on FCIDUMP file from the SFTP server using the key and associated username.
